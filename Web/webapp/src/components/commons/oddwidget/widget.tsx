      ...
      <S.Info_Body isMain={isMain}>
        <S.HomeInfo>
          ...
          <S.Info_Section>
            ...
            <S.Section_Right>
              {homeAwayInfo.home?.info?.winhome}
            </S.Section_Right>
          </S.Info_Section>
          <S.Info_Section>
            <S.Section_Left>{`승리 (어웨이)`}</S.Section_Left>
            <S.Section_Right>
              {homeAwayInfo.home?.info?.winaway}
            </S.Section_Right>
          </S.Info_Section>
          ...
          <S.Info_Section>
            ...
            <S.Section_Right>
              {homeAwayInfo.home?.info.loseshome}
            </S.Section_Right>
          </S.Info_Section>
          <S.Info_Section>
          ...
          <S.Info_Section>
            ...
            <S.Section_Right>
              {homeAwayInfo.home?.info?.fortotal}
            </S.Section_Right>
          </S.Info_Section>
          <S.Info_Section>
            <S.Section_Left>{`평균득점 (홈)`}</S.Section_Left>
            <S.Section_Right>
              {homeAwayInfo.home?.info?.forhome}
            </S.Section_Right>
          </S.Info_Section>
          <S.Info_Section>
            <S.Section_Left>{`평균득점 (어웨이)`}</S.Section_Left>
            <S.Section_Right>
              {homeAwayInfo.home?.info?.foraway}
            </S.Section_Right>
          </S.Info_Section>
        ...
        <S.AwayInfo>
          ...
          <S.Info_Section>
            <S.Section_Left>{`승리 (홈)`}</S.Section_Left>
            <S.Section_Right>
              {homeAwayInfo.away?.info?.winhome}
            </S.Section_Right>
          </S.Info_Section>
          <S.Info_Section>
            <S.Section_Left>{`승리 (어웨이)`}</S.Section_Left>
            <S.Section_Right>
              {homeAwayInfo.away?.info?.winaway}
            </S.Section_Right>
          </S.Info_Section>
          <S.Info_Section_Title>{`TEAM DETAILS (LOSE)`}</S.Info_Section_Title>
          <S.Info_Section>
          ...
          <S.Info_Section>
            <S.Section_Left>{`평균득점 (전체)`}</S.Section_Left>
            <S.Section_Right>
              {homeAwayInfo.away?.info?.fortotal}
            </S.Section_Right>
          </S.Info_Section>
          <S.Info_Section>
            <S.Section_Left>{`평균득점 (홈)`}</S.Section_Left>
            <S.Section_Right>
              {homeAwayInfo.away?.info?.forhome}
            </S.Section_Right>
          </S.Info_Section>
          <S.Info_Section>
            <S.Section_Left>{`평균득점 (어웨이)`}</S.Section_Left>
            <S.Section_Right>
              {homeAwayInfo.away?.info?.foraway}
            </S.Section_Right>
          </S.Info_Section>
          <S.Info_Section_Title>{`SCORE AVERAGE(LOSE)`}</S.Info_Section_Title>
          <S.Info_Section>
